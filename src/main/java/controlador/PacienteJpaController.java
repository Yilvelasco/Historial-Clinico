...
public class PacienteJpaController implements Serializable {
	...
	public List<Paciente> findByName(String name) {
		EntityManager em = getEntityManager();
		try {
			List<Paciente> result = em.createQuery("FROM Paciente p where p.nPaciente like '%" + name + "%'").getResultList();
			return result;
		} catch (Exception e) {
			e.printStackTrace();
			em.close();
	...
	@SuppressWarnings("unchecked")
	public List<Paciente> encontrarPacientePorApellido(String apellido) {
		EntityManager em = getEntityManager();
		try {
			List<Paciente> result = em.createQuery("FROM Paciente p where p.aPaciente like '%" + apellido + "%'").getResultList();
			return result;
		} catch (Exception e) {
			e.printStackTrace();
			em.close();
